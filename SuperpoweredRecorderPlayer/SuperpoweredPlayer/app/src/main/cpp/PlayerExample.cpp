...
static bool audioProcessingPlayer (
...
static bool audioProcessingRecorder (
        void * __unused clientdata, // custom pointer
        short int *audio,           // buffer of interleaved samples
        int numberOfFrames,         // number of frames to process
        int __unused samplerate     // sampling rate
...
Java_com_superpowered_playerexample_MainActivity_StartAudio (
    ...
    audioIO = new SuperpoweredAndroidAudioIO (
            ...
            false,                          // enableInput
            true,                           // enableOutput
            audioProcessingPlayer,                // process callback function
            NULL,                           // clientData
...
extern "C" JNIEXPORT void
Java_com_superpowered_playerexample_MainActivity_StartAudio2 (
        JNIEnv *env,
        jobject  __unused obj,
        jint samplerate,
        jint buffersize,
    ...
    audioIO = new SuperpoweredAndroidAudioIO (
            ...
            true,                           // enableInput
            false,                          // enableOutput
            audioProcessingRecorder,                // process callback function
            NULL                            // clientData
    );
}
...
extern "C" JNIEXPORT void
Java_com_superpowered_playerexample_MainActivity_StopAudio (
        JNIEnv * __unused env,
        jobject __unused obj
) {
    recorder->stop();
